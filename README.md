...
|------|----------|------------|------------|--------|------------|
| 01 | [Suspicious PowerShell Execution](case-studies/01-suspicious-powershell-execution) | MITRE ATT&CK T1059.001 / T1027 | [PowerShell Encoded Execution](detections/detect-suspicious-powershell-execution.md) | Implemented and validated | Windows 10 + Sysmon + Splunk |
