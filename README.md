...
|------|----------|------------|------------|------------|------------|
| 01 | [Suspicious PowerShell execution](case-studies/01) | MITRE ATT&CK T1059.001 | PowerShell abuse detection via (SPL + scheduled alert) (Event ID 1) | Implemented and validated | Windows 10 + Sysmon + Splunk Enterprise |
